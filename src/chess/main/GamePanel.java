...
public class GamePanel extends JPanel implements Runnable {
            ...
            if (mouse.isPressed) {
                if (activeP == null) {
                    ...
                    for (Piece piece : simPieces) {
                        ...
                        if (piece.color == currentColor && piece.col == mouse.x / Board.squareSize
    ...
    public void paintComponent(Graphics g) {
        ...
        if (activeP != null) {
            if (canMove) {
                if (isIllegal(activeP) || opponentCanCaptureKing()) {
                    ...
                    g2.fillRect(activeP.col * Board.squareSize, activeP.row * Board.squareSize, Board.squareSize,
                            Board.squareSize);
        ...
        if (promotion) {
            ...
            for (Piece piece : promoPieces) {
                g2.drawImage(piece.image, piece.getX(piece.col), piece.getY(piece.row), Board.squareSize,
